...
namespace game
{
	namespace controls
	{
		...
		void Init()
		{
			...
			creditsContent[0] = CreatePanel(rect, "CONTROLS", 10, 10, 10, 10, 90, WHITE, BLACK);

			rect.y += creditsContent[0].rect.height;
			creditsContent[1] = CreatePanel(rect, "Player 1", 10, 10, 10, 10, 40, WHITE, BLACK);

			rect.y += creditsContent[1].rect.height * 3;
			creditsContent[2] = CreatePanel(rect, "Player 2", 10, 10, 10, 10, 40, WHITE, BLACK);
		}
